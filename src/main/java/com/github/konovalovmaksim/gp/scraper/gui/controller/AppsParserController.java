...
import com.github.konovalovmaksim.gp.scraper.model.App;
...
import com.github.konovalovmaksim.gp.scraper.service.appsparser.AppsParser;
...
public class AppsParserController implements Initializable, AppsParser.AppParsingListener {
    ...
    private void start() {
        if (apps.size() == 0) {
            Global.showAlert(rb.getString("error"), rb.getString("noAppsUrls"), Global.ALERT);
            return;
        }
