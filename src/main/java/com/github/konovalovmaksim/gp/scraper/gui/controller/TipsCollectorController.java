...
import com.github.konovalovmaksim.gp.scraper.service.tipscollector.TipsCollector;
...
public class TipsCollectorController implements Initializable, TipsCollector.TipsLoadingListener {
    ...
    private void start() {
        ...
        if (!Prefs.getString("parsing_lang").equals("-")) tipsCollector.setLanguage(Prefs.getString("parsing_lang"));
        if (!Prefs.getString("parsing_country").equals("-")) tipsCollector.setCountry(Prefs.getString("parsing_country"));
        enableLoadingMode();
